...
class MyGUI:
    def __init__(self, master):
       ...
       # Create text boxes
        ...
        self.backgroundColour_button = tk.Button(master, text="Ready Shot", command=self.ReadyShot)
        self.backgroundColour_button.grid(row=3, column=3, columnspan=2, pady=10)
    ...
    def doneShot(self):
        self.CueTracking = False
        self.ballDetection = True   #Turn on ball detection
        
    def ReadyShot(self):
        self.CueTracking = True
        self.DetermineUnitTraj = True
        
        self.ballDetection = False #Turn off ball detection
        self.TrajectoryGeneration = False   #Turn off traj Generation
        #Save target angle
    ...
    def submit_values(self):
        ...
        self.TrajectoryGeneration = True    #Turn on trajactory generation
            ...
            try:
                ...
                if self.CueTracking:   
                    ...
                    if found:
                        ...
                        if self.DetermineUnitTraj:
                            magnitude = np.linalg.norm(cueBallTraj[0])
                            unit_traj = cueBallTraj[0]/magnitude
